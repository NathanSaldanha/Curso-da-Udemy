...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if(_search == null){
      ...
      response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=3EJyNjEbuuK8ZD055XE8o5NEghjy7uMx&q=$_search&limit=20&offset=$_offset&rating=G&lang=en");
    }
          ...
          if(_search == null || index < snapshot.data["data"].length)
            ...
            return GestureDetector( //aqui é para permitir que a gente possa clicar na imagem e ser detectado o click
              ...
              onLongPress: (){//para compartilhar a URL do Gif com pressionando por um bom tempo
                Share.share(snapshot.data["data"][index]["images"]["fixed_height_still"]["url"]);//TODO colocar a URL do gif
              },
            );
          else
